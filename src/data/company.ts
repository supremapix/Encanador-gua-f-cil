export const COMPANY_DATA = {
  name: "Encanador Água Fácil 24H",
  legalName: "Encanador Água Fácil 24H Curitiba",
  domain: "www.encanador.servicosnobairro.com.br",
  baseUrl: "https://www.encanador.servicosnobairro.com.br",
  phoneDisplay: "(41) 99569-4912",
  phoneRaw: "5541995694912",
  whatsAppUrl: "https://wa.me/5541995694912",
  address: {
    street: "Rua das Águias, 320",
    neighborhood: "Cidade Industrial de Curitiba – CIC",
    city: "Curitiba",
    state: "PR",
    zipCode: "81450-370",
    formatted: "Rua das Águias, 320 – Cidade Industrial de Curitiba – CIC, Curitiba – PR, CEP 81450-370",
  },
  video: {
    url: "https://www.youtube.com/watch?v=SnnZmIU-ZrE",
    embedId: "SnnZmIU-ZrE",
    title: "Atendimento de Encanador em Curitiba e Região - Encanador Água Fácil",
    description: "Vídeo informativo sobre serviços de encanamento residencial e comercial, reparos hidráulicos e atendimento técnico em Curitiba e Região Metropolitana.",
  },
  heroImages: [
    {
  ...
  workingHours: "Atendimento sob consulta de disponibilidade",
  serviceRadiusKm: 100,
  mainLocation: "Cidade Industrial de Curitiba – CIC"
};
